...
namespace EndToEndMailCourse._03
{
    ...
    public class Workshop03Tests
    {
        ...
        public void ShouldCheckSelectedBookName()
        {
            ...
            #region TEST CODE
            book = driver.FindElement(By.CssSelector(".list-group > .list-group-item.book.selected h4"));
            #endregion
        ...
        public void ShouldCheckLinksDomain()
        {
            ...
            links = driver.FindElements(By.CssSelector(".list-group > .list-group-item.book h4 a"));
            #endregion
